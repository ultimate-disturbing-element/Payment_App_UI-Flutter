      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Column(
              children: [
                Text("Total Amount",style: TextStyle(fontSize:20,color: AppColor.idColor ),),
                SizedBox(height: 10,),
                 Text("\$2840.00",style: TextStyle(fontSize:30,color: AppColor.mainColor,fontWeight: FontWeight.w600 ),)
              ],
            ),
            ...
            AppLargeButton(text: "Done",backgroundColor: Colors.white,textColor: AppColor.mainColor,onTap: (){Navigator.pop(context);},)
          ],
        ),
      ),
    );
